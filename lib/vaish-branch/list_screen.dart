        ...
        children: [
          Padding(
            ...
            child: Text(
              ...
              style: TextStyle(fontFamily: 'Sen', fontSize: 14, color: hintTextColor),
            ),
          ),
          Expanded(
            child: items.isEmpty
                ? Center(child: Text("No items in this list.", style: TextStyle(fontFamily: 'Sen', fontSize: 18, color: hintTextColor)))
                : ListView.builder(
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle: TextStyle(fontFamily: 'PlayfairDisplay',color: hintTextColor),
                      filled: true,
